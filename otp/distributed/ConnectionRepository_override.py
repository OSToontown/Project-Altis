...
from otp.distributed.DoCollectionManagerOR import DoCollectionManagerOR
...
class ConnectionRepository_override(
        DoInterestManager, DoCollectionManagerOR, CConnectionRepository):
    """
    ...
    def __init__(self, connectMethod, config, hasOwnerView = False,
                 threadedNet = None, dcStream = None):
    ...
    def readDCFile(self, dcFileNames=None):
        ...
        self.hashVal = 0
        dcImports = {}
        readResult = dcFile.read(self.dcStream, 'DC stream')
        if not readResult:
