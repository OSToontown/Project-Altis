...
CRBootedReasons = {1: 'An unexpected problem has occurred.  Your connection has been lost, but you should be able to connect again and go right back into the game.',
 ...
 122: 'There was an error authenticating! Make sure your IP Address has been whitelisted on the DubitTown website!',
 124: 'Your installed files are out of date. Try relaunching the launcher to install outdated files.',
 ...
 154: 'DubitTown is now temporarily closed for maintenance. Everyone who was playing has been disconnected from the game.\n\nFor more information, please visit the DubitTown website or the Discord server.',
...
CRMaintenanceCountdownMessage = 'Attention Toons! DubitTown will be going down for maintenance in %d minutes.'
CRMaintenanceMessage = 'Attention Toons! DubitTown is now going down for maintenance.'
...
FriendSecretIntro = "If you are playing DubitTown with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
FriendSecretDetermineSecretAccountRollover = 'A friend across the DubitTown network'
...
SuitBrushOffs = {'f': ["I'm late for a meeting."],
 ...
 'bs': ["There's a restraining order coming your way."],
 ...
 'cn': ["I do not fancy yer time right now."],
 'cc': ["I'm giving you the cold shoulder."],
 'bfh': ['Just keep swimming, toon.'],
 'mdm': ["I'm right in the middle of something."],
...
'sw': ["I'm always swindling from the bottom to the top.",
       "It sure is a nice day for some swindling.",
       "Swindling is my favorite pasttime."],            
...
'hho': ["Let's make this quick. I am late for the board meeting.",
        ...
        "I like to sit in my boss' chair when he isn't looking.",
        "I will always stand by my boss' side.",
        "I'm way a-head of you, Toon.", 
        "I'm married to my job.",
        "My boss calls me a 'Chair Warmer' sometimes because I sit on my days off.",
        "Take a seat, let's discuss some business.",
...
'ca': ["'Zere are many cons to fighting me, but 'zey only affect you.",
        "As un tru' artist said, \"To be, or not to be.\" In zis case, you are not to be.",
        'You are ruining zis masterpiece, no?',
        "Your concept of 'fun' is a mistakenly wrong!",
        "Un brush and un beret, tis all necessary to draw your end.",
        "Le Concept of Zis is for you to go sad."],  
 'mh': ['Are you ready for my take?',
        'Lights, camera, action!',
        "Let's start rolling! This will be your final act.",
        'My teeth are brighter than your future.',
        'There you are! You will be playing the role of the defeated Toon.',
 ...
 'txm' :['Prepare for a Nuclear meltdown.',
         ...
         "I've got my \"ion\" you, toon.",
         'Careful, I am poisonous to Toons.',
         'Toons and toxic waste have one thing in common. They both are disposable.',
         'The only poison needed to take you down is from me.',
         'Steer Nu-clear!'],
 ...
 'mg': ["Even 'Legal Eagle' is terrified of me.",
        "Birds of a feather, let me win this fight altogether.",
 ...
 'bfh': ["Any fin is possible if I don't trout myself.",
         "You're just fishing for trouble.",
         'You will find me swimming in cash.',
         "I won't feel gillty after defeating you.",
         "I'm bigger than any fish you will ever catch.",
         "Something's rather fishy in here. No, it's just me!",
         "I'm a Big Fish in a little pond, toon."],
...
'mdm': ["Whether you're left or right, I'll always be in the middle.",
        "You're in the middle of my way.",
        ...
        "Looks like you found yourself in the middle of some trouble.",
 ...
 'nd': ['In my opinion, your name is mud.',
        ...
        'I know the name of every Cog in Toontown.', 
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 15004: 'Sing some tunes and vote Raccoon!',
 ...
 20354: SuitFaceoffTaunts['ca'][2],
 20355: SuitFaceoffTaunts['ca'][3],
 20356: SuitFaceoffTaunts['ca'][4],
 20357: SuitFaceoffTaunts['ca'][5],
 20358: SuitFaceoffTaunts['cn'][0],
 20359: SuitFaceoffTaunts['cn'][1],
 20360: SuitFaceoffTaunts['cn'][2],
 20361: SuitFaceoffTaunts['sw'][0],
 20362: SuitFaceoffTaunts['sw'][1],
 20363: SuitFaceoffTaunts['sw'][2],
 20364: SuitFaceoffTaunts['mdm'][0],
 20365: SuitFaceoffTaunts['mdm'][1],
 20366: SuitFaceoffTaunts['mdm'][2],
 20367: SuitFaceoffTaunts['mdm'][3],
 20368: SuitFaceoffTaunts['mdm'][4],
 20369: SuitFaceoffTaunts['mdm'][5],
 20370: SuitFaceoffTaunts['mdm'][6],
 20371: SuitFaceoffTaunts['mdm'][7],
 20372: SuitFaceoffTaunts['txm'][0],
 20373: SuitFaceoffTaunts['txm'][1],
 20374: SuitFaceoffTaunts['txm'][2],
 20375: SuitFaceoffTaunts['txm'][3],
 20376: SuitFaceoffTaunts['txm'][4],
 20377: SuitFaceoffTaunts['txm'][5],
 20378: SuitFaceoffTaunts['txm'][6],
 20379: SuitFaceoffTaunts['txm'][7],
 20380: SuitFaceoffTaunts['txm'][7],
 20381: SuitFaceoffTaunts['mg'][0],
 20382: SuitFaceoffTaunts['mg'][1],
 20383: SuitFaceoffTaunts['mg'][2],
 20384: SuitFaceoffTaunts['bfh'][0],
 20385: SuitFaceoffTaunts['bfh'][1],
 20386: SuitFaceoffTaunts['bfh'][2],
 20387: SuitFaceoffTaunts['bfh'][3],
 20388: SuitFaceoffTaunts['bfh'][4],
 20389: SuitFaceoffTaunts['bfh'][5],
 20390: SuitFaceoffTaunts['bfh'][6],
 20391: SuitFaceoffTaunts['hho'][0],
 20392: SuitFaceoffTaunts['hho'][1],
 20393: SuitFaceoffTaunts['hho'][3],
 20394: SuitFaceoffTaunts['hho'][4],
 20395: SuitFaceoffTaunts['hho'][5],
 20396: SuitFaceoffTaunts['hho'][6],
 20397: SuitFaceoffTaunts['hho'][7],
 20398: SuitFaceoffTaunts['hho'][8],
 20399: SuitFaceoffTaunts['hho'][9], 
 21000: 'Here boy!',
 21001: 'Here girl!',
 21002: 'Stay.',
 21003: 'Good boy!',
