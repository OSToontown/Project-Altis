    ...
    case $sel in
        ...
        while true; do
            ...
            case $sel2 in
                ...
                open -a Terminal "`pwd`"  -e  "sh ai-darwin.sh & "
                echo Launching Astron...
                open -a Terminal  "`pwd`"  -e  "sh astron_yaml-darwin-arm.sh &"
                echo Launching the Uberdog Server...
                open -a Terminal  "`pwd`"  -e "sh uberdog-darwin.sh &"
                cd ..
                ...
                while [ true ]
                do
                    python3.9 -m toontown.toonbase.ClientStart
