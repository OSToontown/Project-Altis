...
#Import our DNA parser. All of these are needed for correct funtionality 
...
DNA_CORNICE = DNACornice.__name__
DNA_DOOR = DNADoor.__name__
DNA_FLAT_DOOR = DNAFlatDoor.__name__
DNA_FLAT_BUILDING = DNAFlatBuilding.__name__
DNA_NODE = DNANode.__name__
DNA_GROUP = DNAGroup.__name__
DNA_VIS_GROUP = DNAVisGroup.__name__
DNA_LANDMARK_BUILDING = DNALandmarkBuilding.__name__
DNA_NODE = DNANode.__name__
DNA_PROP = DNAProp.__name__
DNA_SIGN = DNASign.__name__
DNA_SIGN_BASELINE = DNASignBaseline.__name__
DNA_SIGN_TEXT = DNASignText.__name__
DNA_SIGN_GRAPHIC = DNASignGraphic.__name__
DNA_STREET = DNAStreet.__name__
DNA_WALL = DNAWall.__name__
DNA_WINDOWS = DNAWindows.__name__
...
class LevelStyleManager:
    ...
    def createBaselineStyleSample(self, baselineStyle):
        ...
        """
        baseline = DNASignBaseline('DNASignBaselineExample')
