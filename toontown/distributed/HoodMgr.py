...
class HoodMgr(DirectObject.DirectObject):
    ...
    dropPoints = {
        ...
        ToontownGlobals.OutdoorZone: (
            [-94.27, 142.444, 9.087, 263.228, 0, 0],
            [59.732, 136.761, 8.866, 161.006, 0, 0],
            [-37.837, -26.246, 16.054, -95.399, 0, 0],
            [85.775, 39.088, 12.714, 50, 0, 0],
            [95.948, -188.893, 9.049, 340, 0, 0],
            [140.077, 48.241, 8.999, 245, 0, 0],
            [-42.773, 44.727, 10.181, 8, 0, 0],
            [-74.021, -21.066, 12.234, 175, 0, 0]
        ),
