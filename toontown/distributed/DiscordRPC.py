...
class DiscordRPC:
    zone2imgdesc = { # A dict of ZoneID -> An image and a description
        ...
        4400: ["minnies-melodyland", "On Soprano Street"],

        5000: ["daisy-gardens", "In Daisy Gardens"],
        5100: ["daisy-gardens", "On Petunia Place"],
        ...
        6100: ["acorn-acres", "On Acorn Avenue"],
        6200: ["acorn-acres", "On Peanut Place"],
        6300: ["acorn-acres", "On Walnut Way"],
        6400: ["daisy-gardens", "On Legume Way"],
        ...
        19000: ["boardbot-hq", "At Boardbot HQ"],
        19100: ["boardbot-hq", "In The Boardroom Lobby"],
        19200: ["boardbot-hq", "In The Board Office Lobby"],
        13500: ["boardbot-hq", "In The Board Office A"],
        13600: ["boardbot-hq", "In The Board Office B"],
        13700: ["boardbot-hq", "In The Board Office C"]
   }
