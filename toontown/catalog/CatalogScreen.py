...
class CatalogScreen(DirectFrame):
    ...
    def load(self, guiItems, guiButton, guiBack):
        ...
        oldLift = 0.40000000000000002
        lift = 0.40000000000000002
        liftDiff = lift - oldLift
        lift2 = 0.050000000000000003
        smash = 0.75
        priceScale = 0.14999999999999999
        ...
        self.silverLabel = DirectLabel(parent = self, relief = None, pos = (1.05, 0, -0.59999999999999998), scale = priceScale, image = silverModel, image_pos = (-0.40000000000000002, 0, 0.40000000000000002), text = str(localAvatar.emblems[ToontownGlobals.EmblemTypes.Silver]), text_fg = (0.94999999999999996, 0.94999999999999996, 0, 1), text_shadow = (0, 0, 0, 1), text_font = ToontownGlobals.getSignFont(), text_align = TextNode.ALeft)
        base.silverLabel = self.silverLabel
        self.goldLabel = DirectLabel(parent = self, relief = None, pos = (1.05, 0, -0.80000000000000004), scale = priceScale, image = goldModel, image_pos = (-0.40000000000000002, 0, 0.40000000000000002), text = str(localAvatar.emblems[ToontownGlobals.EmblemTypes.Gold]), text_fg = (0.94999999999999996, 0.94999999999999996, 0, 1), text_shadow = (0, 0, 0, 1), text_font = ToontownGlobals.getSignFont(), text_align = TextNode.ALeft)
        base.goldLabel = self.goldLabel
        if not base.cr.wantEmblems:
            self.hideEmblems()
        
        self.newCatalogButton = DirectButton(self.base, relief = None, pos = (0, 0, 0.17000000000000001), frameSize = (-0.20000000000000001, 0.25, 0.45000000000000001, 1.2), image = [
            newDown,
            newDown,
            newDown,
            newUp], image_scale = (1.0, 1.0, smash), image_pos = (0.0, 0.0, lift), pressEffect = 0, command = self.showNewItems, text = TTLocalizer.CatalogNew, text_font = ToontownGlobals.getSignFont(), text_pos = (-0.40000000000000002 - lift, 0.13), text3_pos = (-0.40000000000000002 - lift, 0.10000000000000001), text_scale = 0.080000000000000002, text_fg = (0.35299999999999998, 0.627, 0.627, 1.0), text2_fg = (0.35299999999999998, 0.42699999999999999, 0.42699999999999999, 1.0))
        self.newCatalogButton.hide()
        self.newCatalogButton2 = DirectButton(self.base, relief = None, pos = (0, 0, 0.17000000000000001), frameSize = (-0.20000000000000001, 0.25, 0.45000000000000001, 1.2), image = newDown, image_scale = (1.0, 1.0, smash), image_pos = (0.0, 0.0, lift), pressEffect = 0, command = self.showNewItems, text = TTLocalizer.CatalogNew, text_font = ToontownGlobals.getSignFont(), text_pos = (-0.40000000000000002 - lift, 0.13), text_scale = 0.080000000000000002, text_fg = (0.35299999999999998, 0.627, 0.627, 1.0), text2_fg = (0.35299999999999998, 0.42699999999999999, 0.42699999999999999, 1.0))
        self.newCatalogButton2.hide()
        self.backCatalogButton = DirectButton(self.base, relief = None, pos = (0, 0, 0.26900000000000002), frameSize = (-0.20000000000000001, 0.25, -0.20000000000000001, 0.40000000000000002), image = [
            backDown,
            backDown,
            backDown,
            backUp], image_scale = (1.0, 1.0, smash), image_pos = (0.0, 0.0, lift), pressEffect = 0, command = self.showBackorderItems, text = TTLocalizer.CatalogBackorder, text_font = ToontownGlobals.getSignFont(), text_pos = (0.25 - lift, 0.13200000000000001), text3_pos = (0.25 - lift, 0.112), text_scale = TTLocalizer.CSbackCatalogButton, text_fg = (0.39200000000000002, 0.54900000000000004, 0.627, 1.0), text2_fg = (0.39200000000000002, 0.34899999999999998, 0.42699999999999999, 1.0))
        self.backCatalogButton.hide()
        self.backCatalogButton2 = DirectButton(self.base, relief = None, pos = (0, 0, 0.26900000000000002), frameSize = (-0.20000000000000001, 0.25, -0.20000000000000001, 0.40000000000000002), image_scale = (1.0, 1.0, smash), image_pos = (0.0, 0.0, lift), image = backDown, pressEffect = 0, command = self.showBackorderItems, text = TTLocalizer.CatalogBackorder, text_font = ToontownGlobals.getSignFont(), text_pos = (0.25 - lift, 0.13200000000000001), text_scale = TTLocalizer.CSbackCatalogButton, text_fg = (0.39200000000000002, 0.54900000000000004, 0.627, 1.0), text2_fg = (0.39200000000000002, 0.34899999999999998, 0.42699999999999999, 1.0))
        self.backCatalogButton2.hide()
        self.loyaltyCatalogButton = DirectButton(self.base, relief = None, pos = (0, 0, 0.46899999999999997), frameSize = (-0.20000000000000001, 0.25, -0.84999999999999998, -0.29999999999999999), image = [
            newDown,
            newDown,
            newDown,
            newUp], image_scale = (1.0, 1.0, smash), image_pos = (0.0, 0.0, -1.3999999999999999 + lift), pressEffect = 0, command = self.showLoyaltyItems, text = TTLocalizer.CatalogLoyalty, text_font = ToontownGlobals.getSignFont(), text_pos = (1.0 - lift, 0.13200000000000001), text3_pos = (1.0 - lift, 0.112), text_scale = 0.065000000000000002, text_fg = (0.35299999999999998, 0.627, 0.627, 1.0), text2_fg = (0.35299999999999998, 0.42699999999999999, 0.42699999999999999, 1.0))
        self.loyaltyCatalogButton.hide()
        self.loyaltyCatalogButton2 = DirectButton(self.base, relief = None, pos = (0, 0, 0.46899999999999997), frameSize = (-0.20000000000000001, 0.25, -0.84999999999999998, -0.29999999999999999), image_scale = (1.0, 1.0, smash), image_pos = (0.0, 0.0, -1.3999999999999999 + lift), image = newDown, pressEffect = 0, command = self.showLoyaltyItems, text = TTLocalizer.CatalogLoyalty, text_font = ToontownGlobals.getSignFont(), text_pos = (1.0 - lift, 0.13200000000000001), text_scale = 0.065000000000000002, text_fg = (0.35299999999999998, 0.627, 0.627, 1.0), text2_fg = (0.35299999999999998, 0.42699999999999999, 0.42699999999999999, 1.0))
        self.loyaltyCatalogButton2.hide()
        self.emblemCatalogButton = DirectButton(self.base, relief = None, pos = (0, 0, 1.05), frameSize = (-0.20000000000000001, 0.25, -2.0, -1.45), image = [
            backDown,
            backDown,
            backDown,
            backUp], image_scale = (1.0, 1.0, smash), image_pos = (0.0, 0.0, -1.8999999999999999 + lift), pressEffect = 0, command = self.showEmblemItems, text = TTLocalizer.CatalogEmblem, text_font = ToontownGlobals.getSignFont(), text_pos = (1.75, 0.13200000000000001), text3_pos = (1.75, 0.112), text_scale = 0.065000000000000002, text_fg = (0.35299999999999998, 0.627, 0.627, 1.0), text2_fg = (0.35299999999999998, 0.42699999999999999, 0.42699999999999999, 1.0))
        self.emblemCatalogButton.hide()
        ...
        if len(self.ffList) > 0:
            ...
            self.giftLabel.hide()
            self.friendLabel = DirectLabel(self.base, relief = None, text = 'Friend Name', text_font = ToontownGlobals.getSignFont(), text_pos = (-0.25, 0.13200000000000001), text_scale = 0.068000000000000005, text_align = TextNode.ALeft, text_fg = (0.99199999999999999, 0.94899999999999995, 0.32700000000000001, 1.0), sortOrder = 100, textMayChange = 1)
            self.friendLabel.setPos(0.5, 0, -0.41999999999999998)
            self.friendLabel.hide()
            gui = loader.loadModel('phase_3.5/models/gui/friendslist_gui')
            self.scrollList = DirectScrolledList(parent = self, relief = None, incButton_image = (gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), incButton_relief = None, incButton_pos = (0.0, 0.0, -0.316), incButton_image1_color = Vec4(1.0, 0.90000000000000002, 0.40000000000000002, 1.0), incButton_image3_color = Vec4(1.0, 1.0, 0.59999999999999998, 0.5), incButton_scale = (1.0, 1.0, -1.0), decButton_image = (gui.find('**/FndsLst_ScrollUp'), gui.find('**/FndsLst_ScrollDN'), gui.find('**/FndsLst_ScrollUp_Rllvr'), gui.find('**/FndsLst_ScrollUp')), decButton_relief = None, decButton_pos = (0.0, 0.0, 0.11700000000000001), decButton_image1_color = Vec4(1.0, 1.0, 0.59999999999999998, 1.0), decButton_image3_color = Vec4(1.0, 1.0, 0.59999999999999998, 0.59999999999999998), itemFrame_pos = (-0.17000000000000001, 0.0, 0.059999999999999998), itemFrame_relief = None, numItemsVisible = 8, items = [])
            self.scrollList.setPos(1.2, 0, -0.57999999999999996)
