...
GameDuration = {ToontownGlobals.ToontownCentral: 150,
 ToontownGlobals.OutdoorZone: 145,
 ToontownGlobals.DonaldsDock: 140,
 ToontownGlobals.DaisyGardens: 135,
 ToontownGlobals.MinniesMelodyland: 130,
 ToontownGlobals.TheBrrrgh: 125,
 ToontownGlobals.DonaldsDreamland: 120}
BaseBonusOnCompletion = {ToontownGlobals.ToontownCentral: 15,
 ToontownGlobals.OutdoorZone: 17,
 ToontownGlobals.DonaldsDock: 19,
 ToontownGlobals.DaisyGardens: 21,
 ToontownGlobals.MinniesMelodyland: 23,
 ToontownGlobals.TheBrrrgh: 25,
 ToontownGlobals.DonaldsDreamland: 27}
...
SectionWeights = {ToontownGlobals.ToontownCentral: ((0, 25),
                                   ...
                                   (4, 10),
                                   (5, 0)),
 ToontownGlobals.OutdoorZone: ((0, 15),
                               (1, 25),
                               (2, 25),
                               (3, 15),
                               (4, 10),
 ...
 ToontownGlobals.DonaldsDock: ((0, 15),
                                ...
                                (4, 10),
                                (5, 10)),
 ToontownGlobals.DaisyGardens: ((0, 10),
                                     (1, 10),
                                     (2, 25),
                                     (3, 25),
                                     (4, 15),
...
PercentMaxEnemies = {ToontownGlobals.ToontownCentral: 50,
 ToontownGlobals.OutdoorZone: 60,
 ToontownGlobals.DonaldsDock: 70,
 ToontownGlobals.DaisyGardens: 80,
 ToontownGlobals.MinniesMelodyland: 90,
...
PercentMaxSpawnPoints = {ToontownGlobals.ToontownCentral: 100,
 ToontownGlobals.OutdoorZone: 90,
 ToontownGlobals.DonaldsDock: 80,
 ToontownGlobals.DaisyGardens: 70,
 ToontownGlobals.MinniesMelodyland: 60,
 ToontownGlobals.TheBrrrgh: 50,
 ToontownGlobals.DonaldsDreamland: 40}
