...
class DistributedDivingGameAI(DistributedMinigameAI):
    ...
    fishProportions[5].append(([n, n],
     ...
     [0.6, 1]))
    fishProportions[6]
    fishProportions[6].append(([0, 0.7],
     [0.7, 0.9],
     [0.9, 1],
     [n, n],
     [n, n],
     [n, n]))
    fishProportions[6].append(([0, 0.45],
     [0.45, 0.9],
     [n, n],
     [0.9, 1],
     [n, n],
     [n, n]))
    fishProportions[6].append(([0, 0.2],
     [0.2, 0.5],
     [n, n],
     [0.5, 0.95],
     [0.95, 1],
     [n, n]))
    fishProportions[6].append(([0, 0.1],
     [0.1, 0.3],
     [n, n],
     [0.3, 0.75],
     [0.75, 0.8],
     [0.8, 1]))
    fishProportions[6].append(([n, n],
     [0, 0.15],
     [n, n],
     [0.15, 0.4],
     [n, n],
    ...
    difficultyPatternsAI = {ToontownGlobals.ToontownCentral: [3.5, fishProportions[0], 1.5],
     ...
     ToontownGlobals.OutdoorZone: [1.0, fishProportions[6], 3.3]}
