...
class DMenuQuit(DirectObject):
    ...
    def displayConfirmation(self):
        ...
        self.noBtn = DirectButton(relief = None, text_style = 3, image = (shuffleUp, shuffleDown, shuffleUp), image_scale = (0.8, 0.7, 0.7), image1_scale = (0.83, 0.7, 0.7), image2_scale = (0.83, 0.7, 0.7), text_fg = (1, 1, 1, 1), text = "No", text_pos = (0, -0.02), text_scale = .07, scale = 1.2, command = self.cancelQuitGame)
