...
AvPropDamage = ((((8, 10), (Levels[0][0], Levels[0][1])),
 ...
 ( # Zap
  ((4, 5), (Levels[6][0], Levels[6][1])),
  ((7, 9), (Levels[6][1], Levels[6][2])),
  ((12, 15), (Levels[6][2], Levels[6][3])),
  ((22, 24), (Levels[6][3], Levels[6][4])),
  ((31, 35), (Levels[6][4], Levels[6][5])),
  ((42, 90), (Levels[6][5], Levels[6][6])),
  ((115, 115), (Levels[6][6], MaxSkill))
 ),
