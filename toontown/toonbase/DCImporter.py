...
dclass DistributedToon : DistributedPlayer {
  ...
  setCogStatus(uint32[] = [1 * 80]) required ownrecv db;
  setCogCount(uint32[] = [0 * 80]) required ownrecv db;
  setCogRadar(uint8[] = [0 * 10]) required ownrecv db;
  setBuildingRadar(uint8[] = [0 * 10]) required ownrecv db;
  setCogLevels(uint8[] = [0 * 10]) required broadcast ownrecv db;
  setCogReviveLevels(int8[] = [-1 * 10]) required broadcast ownrecv db;
  setCogTypes(uint8[] = [0 * 10]) required broadcast ownrecv db;
  setCogParts(uint32[] = [0 * 10]) required broadcast ownrecv db;
  setCogMerits(uint16[] = [0 * 10]) required broadcast ownrecv db;
  setPromotionStatus(uint8[] = [0 * 10]) required broadcast ownrecv db;
