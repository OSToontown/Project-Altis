...
169: {QUEST: 'Sasha Sidesplitter has been complaining about the Lawbots on Loopy Lane.\x07Mind looking into it?\x07__where__',
		GREETING: 'Hey there __avName__!'},
170: {QUEST: 'These Lawbots are terrorizing Loopy Lane! They are spouting their legalese throughout the street!\x07One of them even tried to sue a fire hydrant!\x07You gotta help us here on Loopy Lane!\x07Take out five of the highest level bossbots here, that should take care of them!',
		GREETING: 'Oh thank goodness you are here!'},
171: {QUEST: "NO! I WON'T CEASE AND DESIST!\x07...Oh, you're back already?\x07You took out those lawbots?!?\x07Oh thank you so much!\x07Go back to Harold, he would love to hear that we are doing just fine now!",
		COMPLETE: "I've heard about what you did for the toons of Loopy Lane.\x07As a show of our gratitude, the officers and I have an award for you."}
}
