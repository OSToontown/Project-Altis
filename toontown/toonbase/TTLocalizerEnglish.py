...
QuestDialogDict = {
 101: {QUEST: "Oh, hello there _avName_!\x07I'm sure glad to see you here, I just got a call from one of my officers on Loopy Lane.\x07Herbert would like to get you involved with some of the locals.\x07_where_"},
 102: {QUEST: "Ah, you must be _avName_.\x07Welcome to Toontown!\x07The other officers and I make sure that Loopy Lane stays safe and that it's residents are happy.\x07Postmaster Pete made sure to ask us all about the new toons in town.\x07He'd like you to visit him in his office._where_"},
