...
ExpMoneyReward = 'Congratulations on reaching level %s! You can now carry 50 additional jellybeans'
...
QuestDialogDict = {160: {GREETING: '',
 ...
 1051: {GREETING: "Hey, hey, hey!",
		QUEST: "Have ya' ever heard of the new Zap Gags?\x07They have been recently invented with the assistance one of Loony Lab's former scientists, _toNpcName_.\x07I asked him if I could do an interview on him down on Wacky Way and he agreed to it.\x07He REALLY wanted the interview to be about his latest Tesla Coil model, so it must be exciting!_where_",
