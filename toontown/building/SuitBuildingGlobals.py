...
buildingMinMax = {
    ...
    #ToontownGlobals.RedwoodRoad: (config.GetInt('redwood-road-building-min', 6),
    #                              config.GetInt('redwood-road-building-max', 12)),
    ToontownGlobals.RedwoodRoad: (0, 0),
...
buildingChance = {
    ...
    ToontownGlobals.RedwoodRoad: 0.0,#config.GetFloat('redwood-road-building-chance', 100.0),
