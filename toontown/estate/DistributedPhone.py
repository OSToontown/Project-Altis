...
class DistributedPhone(DistributedFurnitureItem.DistributedFurnitureItem):
    ...
    def setupCord(self):
        ...
        self.cord.node().setBounds(BoundingSphere(Point3(-1.0, -3.2000000000000002, 2.6000000000000001), 2.0))
    ...
    def requestGiftPurchase(self, item, targetDoID, callback, optional = -1):
        ...
        context = self.getCallbackContext(callback, [
            item])
        self.sendUpdate('requestGiftPurchaseMessage', [
            context,
            targetDoID,
            blob,
            optional])
    ...
    def __receiverToHand(self, toon):
        ...
        self.receiverGeom.setPosHpr(0.090681300000000006, 0.38037500000000002, 0.10000000000000001, 32.409999999999997, 70.680000000000007, 137.03999999999999)
