...
class DistributedSuitPlannerAI(DistributedObjectAI.DistributedObjectAI, SuitPlannerBase.SuitPlannerBase):
    ...
    [ToontownGlobals.LullabyLane, 8, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 5, 40, 40, 10), (6, 7, 8, 9, 10), [], 25],
    [ToontownGlobals.PajamaPlace, 8, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (5, 5, 5, 5, 80), (6, 7, 8, 9, 10), [], 30],
    [ToontownGlobals.TwilightTerrace, 8, 20, 0, 99, 100, 4, (1, 5, 10, 40, 60, 80), (40, 40, 5, 5, 10), (6, 7, 8, 9, 10), [], 25],
    ...
    def pickLevelTypeAndTrack(self, level=None, type=None, track=None):
        ...
        if type is None:
            if ZoneUtil.isCogHQZone(self.zoneId):
                typeChoices = list(range(max(level - 4, 1), min(level, self.MAX_SUIT_TYPES_HQ) + 1))
