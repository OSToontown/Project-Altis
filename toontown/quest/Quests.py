...
QuestDict = {
 ...
 1011: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 6, 2), Any, ToonHQ, Any, NA, DefaultDialog),
 1012: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 5, 3), Any, ToonHQ, Any, NA, DefaultDialog),
 1013: (TT_TIER + 2, Start, (CogLevelQuest, ToontownGlobals.ToontownCentral, 4, 4), Any, ToonHQ, Any, NA, DefaultDialog),
 ...
 1227: (TT_TIER + 2, Start, (CogLevelQuest, Anywhere, 9, 2), Any, ToonHQ, Any, NA, DefaultDialog),
 1228: (TT_TIER + 2, Start, (CogLevelQuest, Anywhere, 7, 3), Any, ToonHQ, Any, NA, DefaultDialog),
 1229: (TT_TIER + 2, Start, (CogLevelQuest, Anywhere, 5, 4), Any, ToonHQ, Any, NA, DefaultDialog),
...
RewardDict = {100: (MaxHpReward, 1),
 ...
 205: (MaxGagCarryReward, 55, TTLocalizer.QuestsExtraLargeBag),
 206: (MaxGagCarryReward, 60, TTLocalizer.QuestsSmallBackpack),
 207: (MaxGagCarryReward, 70, TTLocalizer.QuestsMediumBackpack),
 208: (MaxGagCarryReward, 80, TTLocalizer.QuestsLargeBackpack),
 209: (MaxGagCarryReward, 90, TTLocalizer.QuestsExtraLargeBackpack),
