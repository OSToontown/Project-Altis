...
# Task One
 ...
 2016: ([], Cont, (RecoverItemQuest, Anywhere, 1, 2006, 50, Any, 'type'), 2405, 2405, NA, 2017, TTLocalizer.QuestDialogDict[2016], 10, 300),
 2017: ([], Cont, (RecoverItemQuest, Anywhere, 3, 2007, 75, 'cc', 'type'), 2405, 2405, NA, 2018, TTLocalizer.QuestDialogDict[2017], 10, 300),
 ...
 2027: ([], Cont, (DeliverItemQuest, 2015), 2002, 2136, NA, NA, TTLocalizer.QuestDialogDict[2027], 300, 35),
 2028: ([], Cont, (VisitQuest,), 2136, 2136, NA, NA, TTLocalizer.QuestDialogDict[2028], 300, 35),
 2029: ([], Cont, (VisitQuest,), 2136, 2136, NA, NA, TTLocalizer.QuestDialogDict[2029], 300, 35),
 
 # Task Three
 2030: ([], Start, (VisitQuest,), 2001, 2005, NA, 2031, TTLocalizer.QuestDialogDict[2030], 300, 35),
 2031: ([], Cont, (CogTrackQuest, Anywhere, 3, 's'), 2005, 2005, NA, (2032, 2033), TTLocalizer.QuestDialogDict[2031], 300, 35),
 2032: ([], Cont, (CogTrackQuest, Anywhere, 3, 'm'), 2005, 2005, NA, (2034, 2035), TTLocalizer.QuestDialogDict[2032], 300, 35),
 2033: ([], Cont, (CogTrackQuest, Anywhere, 3, 'l'), 2005, 2005, NA, (2034, 2035), TTLocalizer.QuestDialogDict[2033], 300, 35),
 2034: ([], Cont, (CogTrackQuest, Anywhere, 3, 'c'), 2005, 2005, NA, 2038, TTLocalizer.QuestDialogDict[2034], 300, 35),
 2035: ([], Cont, (CogTrackQuest, Anywhere, 3, 'g'), 2005, 2005, NA, 2038, TTLocalizer.QuestDialogDict[2035], 300, 35),
 2036: ([], Cont, (VisitQuest,), 2005, 2005, NA, 2038, TTLocalizer.QuestDialogDict[2036], 300, 35),
 2037: ([], Cont, (VisitQuest,), 2005, 2005, NA, 2038, TTLocalizer.QuestDialogDict[2037], 300, 35),
 2038: ([], Cont, (EliteCogQuest, Anywhere, 5), 2005, 2005, NA, NA, TTLocalizer.QuestDialogDict[2038], 300, 35),
 
 # Task Four
 2040: ([], Start, (VisitQuest,), 2001, 2201, NA, 2041, TTLocalizer.QuestDialogDict[2040], 370, 70),
 2041: ([], Cont, (RecoverItemQuest, ToontownGlobals.ToontownCentral, 10, 2016, Easy, 3, 'level'), 2201, 2201, NA, NA, TTLocalizer.QuestDialogDict[2041], 370, 70),
 2042: ([], Cont, (VisitQuest,), 2201, 2201, NA, NA, TTLocalizer.QuestDialogDict[2042], 370, 70),
 2043: ([], Cont, (VisitQuest,), 2201, 2201, NA, NA, TTLocalizer.QuestDialogDict[2043], 370, 70),
 2044: ([], Cont, (VisitQuest,), 2201, 2201, NA, NA, TTLocalizer.QuestDialogDict[2044], 370, 70),
 2045: ([], Cont, (VisitQuest,), 2201, 2201, NA, NA, TTLocalizer.QuestDialogDict[2045], 370, 70),
 2046: ([], Cont, (VisitQuest,), 2404, 2209, NA, NA, TTLocalizer.QuestDialogDict[2046], 370, 70),
 ...
 2058: ([], Cont, (CogLevelQuest, Anywhere, 7, 2), 2109, 2109, NA, 2059, TTLocalizer.QuestDialogDict[2058], 385, 20),
 ...
 2062: ([], Cont, (CogTrackQuest, Anywhere, 7, 'l'), 2318, 2318, NA, 2063, TTLocalizer.QuestDialogDict[2062], 350, 35),
 2063: ([], Cont, (CogLevelQuest, Anywhere, 8, 2), 2318, 2318, NA, NA, TTLocalizer.QuestDialogDict[2063], 350, 35),

 # Task Seven
 2070: ([], Start, (VisitQuest,), 2001, 2402, NA, 2071, TTLocalizer.QuestDialogDict[2070], 375, 50),
 2071: ([], Cont, (RecoverItemQuest, Anywhere, 1, 2023, Easy, 's', 'track'), 2402, 2402, NA, (2072, 2073), TTLocalizer.QuestDialogDict[2071], 375, 50),
 2072: ([], Cont, (RecoverItemQuest, Anywhere, 1, 2024, Easy, 'm', 'track'), 2402, 2402, NA, (2075, 2076), TTLocalizer.QuestDialogDict[2072], 375, 50),
 2073: ([], Cont, (RecoverItemQuest, Anywhere, 1, 2025, Easy, 'l', 'track'), 2402, 2402, NA, (2075, 2076), TTLocalizer.QuestDialogDict[2073], 375, 50),
 2074: ([], Cont, (RecoverItemQuest, Anywhere, 1, 2026, Easy, 'c', 'track'), 2402, 2402, NA, (2075, 2076), TTLocalizer.QuestDialogDict[2074], 375, 50),
 ...
 2091: ([], Cont, (CogQuest, ToontownGlobals.ToontownCentral, 10, Any), 2208, 2208, NA, 2092, TTLocalizer.QuestDialogDict[2091], 375, 25),
 2092: ([], Cont, (CogLevelQuest, ToontownGlobals.ToontownCentral, 3, 3), 2208, 2208, NA, 2093, TTLocalizer.QuestDialogDict[2092], 375, 25),
 2093: ([], Cont, (CogLevelQuest, 2100, 1, 5), 2208, 2208, NA, 2094, TTLocalizer.QuestDialogDict[2093], 375, 25),
 2094: ([], Cont, (CogLevelQuest, 2200, 3, 3), 2208, 2208, NA, 2095, TTLocalizer.QuestDialogDict[2094], 375, 25),
 2095: ([], Cont, (CogLevelQuest, 2300, 3, 3), 2208, 2208, NA, 2096, TTLocalizer.QuestDialogDict[2095], 375, 25),
 2096: ([], Cont, (RecoverItemQuest, ToontownGlobals.ToontownCentral, 1, 2028, Medium, 4, 'level'), 2208, 2208, NA, NA, TTLocalizer.QuestDialogDict[2096], 375, 25),

 # Task Ten
 2100: ([], Start, (VisitQuest,), 2001, 2222, NA, 2101, TTLocalizer.QuestDialogDict[2100], 375, 35),
 2101: ([], Cont, (CogLevelQuest, Anywhere, 5, 2), 2222, 2222, NA, 2102, TTLocalizer.QuestDialogDict[2101], 375, 35),
 2102: ([], Cont, (CogLevelQuest, Anywhere, 4, 3), 2222, 2222, NA, 2103, TTLocalizer.QuestDialogDict[2102], 375, 35),
 2103: ([], Cont, (CogLevelQuest, Anywhere, 3, 4), 2222, 2222, NA, NA, TTLocalizer.QuestDialogDict[2103], 375, 35),
 2104: ([], Cont, (VisitQuest,), 2222, 2222, NA, NA, TTLocalizer.QuestDialogDict[2104], 375, 35),
 2105: ([], Cont, (VisitQuest,), 2222, 2222, NA, NA, TTLocalizer.QuestDialogDict[2104], 375, 35),
 2106: ([], Cont, (VisitQuest,), 2222, 2222, NA, NA, TTLocalizer.QuestDialogDict[2104], 375, 35),
 2107: ([], Cont, (VisitQuest,), 2222, 2222, NA, NA, TTLocalizer.QuestDialogDict[2104], 375, 35),
 
 # Task Eleven
 2110: ([], Start, (VisitQuest,), 2001, 6214, NA, 2111, TTLocalizer.QuestDialogDict[2110], 325, 50),
 2111: ([], Cont, (RecoverItemQuest, Anywhere, 5, 2029, Easy, Any, 'type'), 6214, 6214, NA, 2112, TTLocalizer.QuestDialogDict[2111], 325, 50),
 2112: ([], Cont, (DeliverItemQuest, 2030), 6214, 2312, NA, 2113, TTLocalizer.QuestDialogDict[2112], 325, 50),
 2113: ([], Cont, (VisitQuest,), 6214, 2303, NA, 2115, TTLocalizer.QuestDialogDict[2113], 325, 50),
 2114: ([], Cont, (VisitQuest,), 6214, 2303, NA, 2115, TTLocalizer.QuestDialogDict[2113], 325, 50),
 ...
 2120: ([2118, 2107, 2096, 2086, 2079, 2064, 2059, 2041, 2038, 2027, 2018, 2005], Start, (VisitQuest,), 2216, 2001, 300, 2121, TTLocalizer.QuestDialogDict[2120], 500, 75),
 ...
 2127: ([], Cont, (CogLevelQuest, ToontownGlobals.ToontownCentral, 4, 5), 2214, 2214, 300, 2128, TTLocalizer.QuestDialogDict[2127], 500, 75),
 2128: ([], Cont, (BuildingQuest, Anywhere, 1, Any, 1), 2214, 2214, 300, 2129, TTLocalizer.QuestDialogDict[2128], 500, 75),
 2129: ([], Cont, (VisitQuest,), 2214, 2216, 300, 2130, TTLocalizer.QuestDialogDict[2129], 500, 75),
 2130: ([], Cont, (DeliverItemQuest, Anywhere, 2035), 2216, 2201, 300, 2131, TTLocalizer.QuestDialogDict[2130], 500, 75),
 2131: ([], Cont, (RecoverItemQuest, Anywhere, 15, 2036, VeryEasy, AnyFish), 2201, 2201, 300, 2132, TTLocalizer.QuestDialogDict[2131], 500, 75),
 2132: ([], Cont, (VisitQuest,), 2226, 2216, 300, 2133, TTLocalizer.QuestDialogDict[2132], 500, 75),
 2133: ([], Cont, (DeliverItemQuest, Anywhere, 2035), 2216, 2201, 300, 2134, TTLocalizer.QuestDialogDict[2133], 500, 75),
 2134: ([], Cont, (RecoverItemQuest, Anywhere, 5, 2016, Easy, 4, 'level'), 2201, 2201, 300, 2135, TTLocalizer.QuestDialogDict[2134], 500, 75),
 2135: ([], Cont, (VisitQuest,), 2201, 2216, 300, 2136, TTLocalizer.QuestDialogDict[2135], 500, 75),
