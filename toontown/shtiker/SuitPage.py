...
SHADOW_SCALE_POS = ((1.225, 0, 10, -0.03),# Flunky
 ...
 (1.25, 0, 10, -0.03),# Bottom Feeder
 (1.0, 0, 10, -0.01),# Bloodsucker
 (1.0, 0.005, 10, -0.01),# Double Talker
 (1.0, 0, 10, -0.01),# Ambulance Chaser
 (0.9, 0.005, 10, -0.01),# Backstabber
 (0.95, 0, 10, -0.01),# Spin Doctor
 (1.125, 0.005, 10, -0.035),# Legal Eagle
 (0.85, -0.005, 10, -0.035),# Big Wig
 (1.2, 0, 10, -0.01),# Short Change
 (1.05, 0, 10, 0),# Penny Pincher
 (1.1, 0, 10, -0.04),# Tightwad
 (1.0, 0, 10, 0),# Bean Counter
 (0.95, 0.0175, 10, -0.015),# Number Cruncher
 (1.0, 0, 10, -0.06),# Money Bags
 (0.95, 0.02, 10, -0.0175),# Loan Shark
 (0.9, 0, 10, -0.03),# Robber Baron
 (1.15, 0, 10, -0.01),# Cold Caller
 (1.0, 0, 10, 0),# Telemarketer
 (1.0, 0, 10, 0),# Name Dropper
 (1.1, 0, 10, -0.04),# Glad Hander
 (0.93, 0.005, 10, -0.01),# Mover & Shaker
 (0.95, 0.005, 10, -0.01), # Two-Face
 (1.0, 0, 10, -0.02),# The Mingler
 (0.9, 0.0025, 10, -0.03),# Mr. Hollywood
 (1.15, 0, 10, -0.01),# Con Artist
 (1.0, 0, 10, 0),# Connoisseur
 (1.0, 0, 10, 0),# The Swindler
 (1.1, 0, 10, 0),# Middleman
 (0.93, 0.005, 10, -0.01),# Toxic Manager
 (0.95, 0.005, 10, -0.01), # Magnate
 (1.0, 0, 10, -0.02),# Big Fish
 (1.4, 0.0025, 10, -0.03))# Head Honcho
