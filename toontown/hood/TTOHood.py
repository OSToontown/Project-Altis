from toontown.safezone.TTOSafeZoneLoader import TTOSafeZoneLoader
from toontown.town.TTOTownLoader import TTOTownLoader
from toontown.toonbase import ToontownGlobals
from toontown.hood.ToonHood import ToonHood
from otp.ai.MagicWordGlobal import *

class TTOHood(ToonHood):
    notify = directNotify.newCategory('TTHood')

    ID = ToontownGlobals.ToontownCentralOld
    TOWNLOADER_CLASS = TTOTownLoader
    SAFEZONELOADER_CLASS = TTOSafeZoneLoader
